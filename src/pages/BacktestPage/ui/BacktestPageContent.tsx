...
import { BacktestPageHeader } from './BacktestPageHeader'
import { BacktestBaselineColumn } from './BacktestBaselineColumn'
import { BacktestWhatIfColumn } from './BacktestWhatIfColumn'
import { BacktestCompareBlock } from './BacktestCompareBlock'
...
export function BacktestPageContent({ className, baselineSummary, profiles }: BacktestPageContentProps) {
