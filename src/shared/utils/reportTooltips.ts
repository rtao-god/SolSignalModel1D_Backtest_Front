...
const CURRENT_PREDICTION_KEYS: Record<string, string> = {
    Набор: 'Live — карточка прогноза на текущий день; Backfilled — карточка за прошлую дату, где фактический исход уже известен.',
...
const DIAGNOSTICS_EXACT: Record<string, string> = {
    ...
    'Cap avg/min/max':
        'Средняя/минимальная/максимальная доля капитала на сделку, использованная в сделках. Значения в % от бакета.',
    'Cap p50/p90': 'Квантили p50/p90 по доле капитала на сделку: медиана и верхний хвост распределения.',
    ...
    Cap: 'Доля капитала на сделку, применённая в этой сделке.',
    ...
    'CapZero%': 'Доля пропусков из-за нулевой доли капитала на сделку.',
