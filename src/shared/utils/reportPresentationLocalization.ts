...
const CURRENT_PREDICTION_KEY_LABEL_RU: Record<string, string> = {
    ...
    WithdrawnTotalUsd: 'WithdrawnTotalUsd',
    Set: 'Набор',
    ...
    'Actual MinMove over 24h (log)': 'Факт MinMove за 24ч (log)',
    'Forecast MinMove (causal, log)': 'Прогнозный MinMove (казуальный, log)',
    'Delta MinMove (actual - forecast, log)': 'Δ MinMove (факт - прогноз, log)',
