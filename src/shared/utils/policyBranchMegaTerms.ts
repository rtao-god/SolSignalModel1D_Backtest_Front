...
const TERMS: Record<string, PolicyBranchMegaTermDefinition> = {
    ...
    StopReason: {
        ...
        title: 'StopReason',
        description:
            'Причина завершения периода: "До конца периода" — дошли до последнего дня истории; "Ликвидация (ранний stop)" — жёсткая остановка из‑за смерти счёта/бакета; "Ранний stop без ликвидации" — подозрительная ранняя остановка без факта ликвидации.',
    ...
    AccRuin: {
        ...
        title: 'AccRuin',
        description:
            'Account Ruin Count: для Cross это «смерть» аккаунта при первой критической просадке, для Isolated — достаточно смерти одного бакета. В таблице обычно 0 или 1.',
        tooltip: 'Факт «смерти» аккаунта/бакета.'
    },
    RealLiq: {
        key: 'RealLiq',
        title: 'RealLiq',
