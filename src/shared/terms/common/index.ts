...
import {
    ...
    SUM_FUNDING_NET_USD_DESCRIPTION,
...
const COMMON_REPORT_COLUMN_TOOLTIPS: CommonReportColumnTooltipMap = {
    ...
    AccountRuinCount: ACCOUNT_RUIN_DESCRIPTION,
    Recovered: RECOVERED_DESCRIPTION,
    RecovDays: RECOV_DAYS_DESCRIPTION,
    'ReqGain%': REQ_GAIN_DESCRIPTION,
    StartCapitalUsd: START_CAP_DESCRIPTION,
    'Стартовый капитал': START_CAP_DESCRIPTION,
    EquityNowUsd: CURRENT_BALANCE_DESCRIPTION,
    ...
    'OnExch%': ON_EXCHANGE_PCT_DESCRIPTION,
    'MaxDD%': DRAWDOWN_DESCRIPTION,
    Sharpe: SHARPE_DESCRIPTION,
    Sortino: SORTINO_DESCRIPTION,
    Calmar: CALMAR_DESCRIPTION,
    'Cagr': CAGR_DESCRIPTION,
    HadLiquidation: LIQUIDATION_DESCRIPTION,
    WithdrawnTotalUsd: WITHDRAWN_PROFIT_DESCRIPTION,
    FundingNetUsd: SUM_FUNDING_NET_USD_DESCRIPTION
}
